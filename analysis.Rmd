...
df_ss$is_sync %>% length  # total number of tweets
sync_n <- df_ss$is_sync %>% sum
sync_n
async_n <- df_ss$is_sync %>% length(.) - sync_n
async_n
...
to_plot$date_r <- to_plot$date_r %>% as_date
